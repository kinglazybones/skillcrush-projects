...
def get_message(birth_path_num)
	...
	when 3
	message = "Your numerology number is #{birth_path_num}.\nNumber Three is sociable, friendly, and outgoing vibration. Kind, positive, and optimistic, Threes enjoy life and have a good sense of humor. Ruled by Jupiter."
